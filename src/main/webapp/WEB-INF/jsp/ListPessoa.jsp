        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="pessoa" items="${pessoaList}">
                <tr>
                    ...
                    <td>
                        <a href="/pessoa/edit/${pessoa.id}" style="margin:auto; text-align:center; display:block;"
                           class="btn btn-success">Editar</a>
                    </td>
                    <td>
                        <a href="/pessoa/delete/${pessoa.id}" style="margin:auto; text-align:center; display:block;"
